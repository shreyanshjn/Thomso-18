                                        ...
                                        <div className="overlay">
                                            <div className="card-footer-icons">
                                                <div style={{
                                                    ...
                                                    {member.fblink ?  <a href={member.fblink} target="_blank" rel="noopener noreferrer"> <div className="card-footer-fbdiv">  <img src={fblogo} className="card-footer-iconsImage" alt="fblogo" /></div></a>: null}
                                                    {member.instalink ? <div className="card-footer-instadiv"><a href={member.instalink} target="_blank" rel="noopener noreferrer"><img src={inlogo} className="card-footer-iconsImage" alt="inlogo" /></a></div>
                                                    : null}
                                                    {member.linkedlnlink ?<div className="card-footer-linkediv"><a href={member.linkedlnlink} target="_blank" rel="noopener noreferrer"> <img src={ldlogo} className="card-footer-iconsImage" alt="lilogo" /></a></div>: null}
