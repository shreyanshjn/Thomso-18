const Function = () => {
        ...
        function mobileoptionsreveal(){
            ...
            var numbchangescene = new ScrollMagic.Scene({
            ...
            .addTo(controller);
                ...
                var thirdwholepagescene = new ScrollMagic.Scene({
                    triggerElement: "#pagereveal",
                    offset:-100,
                    tweenChanges: true
                })
    ...
    let translate = 'translate(' + x + 'px, ' + y + 'px) scale(1)';

    document.querySelector(".mainfirst").style.transform=translate;

    window.requestAnimationFrame(moveBackground);
    }

    document.querySelector(".mainfirst1").addEventListener('mousemove click', function(e) {
