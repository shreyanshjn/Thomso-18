                    ...
                    <div className="zonal-common-comp1-register">
                        ...
                        {this.props.downloadPdf ?
                            <div className="zonal-common-comp1-register-child2">
                                <div>
                                    <a href={`https://thomso.in/pdf/zonals/${this.props.downloadPdf}`} target="_blank"> <abbr title="Click to download"><button className="zonal-comp1-button">RULEBOOK</button></abbr></a>
                                </div>
                            </div>
                            : null}
                    </div>
