        ...
        return (
            <div className="zonal-common-section2"> 
                <div style={{position:'relative'}}>
                    <Fade in={this.state.activeState === "zonals"}> <SectionComp Name="zonals-comp-dance-transform" heading="Karwaan" content={this.state.karwaan} /></Fade>
                    ...
                    <Fade in={this.state.activeState === "mrthomso"}> <SectionComp Name="zonals-comp-dance-transform" heading="MR & MISS THOMSO" content={this.state.mrthomso} downloadPdf="MrThomso.pdf"/></Fade>
