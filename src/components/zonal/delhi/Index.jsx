...
import painting from "../src/img/Painting.png";
            ...
            <div>
                ...
                <div className="delhi-zonals-painting">
                    <div className="delhi-painting-button-div">
                        <a href="https://www.townscript.com/e/oil-painting-workshop-by-expert-sweety-singh-234221" target="_blank"><button className="delhi-painting-button-child"j>Register</button></a>
                    </div>
                </div>
