...
export default class Erorsvg extends React.Component{
    render(){
      ...
      {/* <svg id="planet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <circle className=" errorhover" cx="319.166" cy="208.081" r="28.389" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="234.463" cy="273.978" r="19.358" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="307.493" cy="144.207" r="12.584" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="163.289" cy="255.495" r="19.358" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="230.586" cy="365.92" r="19.358" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="302.221" cy="353.781" r="19.357" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="358.827" cy="284.847" r="11.079" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="220.465" cy="156.416" r="11.079" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="154.027" cy="171.743" r="5.819" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="391.387" cy="251.305" r="5.819" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="145.077" cy="302.473" r="5.819" fill="#D83A4E"/>
        ...
        <circle className=" errorhover" cx="187.342" cy="355.265" r="5.819" fill="#D83A4E"/>
    ...
    <g>
      ...
      <path className=" errorhover" style={{fill:"#F3D55B"}} d="M55,5.5h-1.586L51,3.086V1.5c0-0.552-0.447-1-1-1s-1,0.448-1,1v1.586L46.586,5.5H45
        ...
        S55.553,5.5,55,5.5z"/>
      {/* <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="6" cy="9.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="25" cy="12.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="53" cy="17.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="36.001" cy="5.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="35" cy="45.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="3" cy="54.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="1" cy="43.5" r="1"/>
       */}
      ...
      {/* <circle className=" errorhover" style={{fill:"#F3D55B"}} cx="44" cy="54.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B;"}} cx="53" cy="42.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B;"}}cx="1" cy="4.5" r="1"/>
      <circle className=" errorhover" style={{fill:"#F3D55B;"}} cx="12" cy="2.5" r="1"/>
    */}
    </g>
    <g>
    </g>
