...
export default class ParticipantIndex extends React.Component {
  constructor() {
    super();
    this.state = {
      userData: "",
      ...
      <React.Fragment >
        ...
        {this.state.isAuthenticated ? (
          <div>
            ...
            {/* <Route exact path="/participants/logout" render={props => (<LogoutIndex {...props} updateRoutes={this.handleUpdate} />)} /> */}
            <Route exact path="/participants/leaderboard" render={props => (<LeaderboardIndex {...props} userData={this.state.userData} />)} />
            <Route exact path="/participants/timeline" component={TimelineIndex} />
            <Route exact path="/participants/contact" render={props => (<ContactIndex {...props} userData={this.state.userData} />)} />
            <Route exact path="/participants/ideas" component={IdeasIndex} />
            <Route exact path="/participants/" component={HomeIndex} />
